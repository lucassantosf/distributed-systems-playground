...
from proto.generated.product import product_pb2 as product_dot_product__pb2
...
class ProductServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.GetProduct = channel.unary_unary(
                ...
                response_deserializer=product_dot_product__pb2.Product.FromString,
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetProduct': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=product_dot_product__pb2.Product.SerializeToString,
            ),
...
class ProductService:
    ...
    def GetProduct(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            product_dot_product__pb2.Product.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
