...
# Card 8  : setup_tracing(app) — auto-instrumentação OTel ✅
...
# ── Card 8: inicializar tracing ANTES dos routers para que o
# FastAPIInstrumentor envolva todos os endpoints ──────────────────────────────
setup_tracing(app)
